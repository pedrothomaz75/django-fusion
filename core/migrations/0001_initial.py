    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-cog', 'engranagem'), ('lni-stats-up', 'gráfico'), ('lni-user', 'usuário'), ('lni-layers', 'design'), ('lni-mobile', 'celular'), ('lni-rocket', 'foguete')], max_length=12, verbose_name='Ícone')),
            ],
            options={
